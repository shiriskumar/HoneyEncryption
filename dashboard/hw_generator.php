...
echo "Checking Details for: </br> UserID: " . $ping_id . "</br></br>";
...
if($ping_p2==NULL||$ping_p1==NULL){ //this is a new column
	...
	//Generate 3 random numbers with sum 19
	//----------------------------------------------------------
	$number_of_groups   = 3;
	$sum_to             = 19;
	...
	for($i=0; $i<$mod2; $i++){
		...
		$noise = rand(1, 999); //create a numeric noice
	...
	$final_array = array_merge($pieces, $temp_array);//merge the 2 arrays
