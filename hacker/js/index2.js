...
/* fake console stuff */
var commandStart = ['Sending Request', 
                'Searching ', 
                'http://aws.amazon.com/userid=097580q59065qtot87w5&mc=4 ', 
                'Logging In... ', 
                'Compressing ', 
                'sys(send.py honeydev.sql http://aws.amazon.com/userid=097580q59065qtot87w5&mc=4 ) ', 
                'Uploading passwords.txt ',  
                'Waiting... ', 
                'ACK Recived ',
                 'Downloading '],
    commandParts = ['Data Structure', 
                    'http://aws.amazon.com/userid=097580q59065qtot87w5 ', 
                    'Texture', 
                    'TLS Reports', 
                    ' .... explode(honeydev.sql) ... ', 
                    'Connecting 120.56.399.5 : 8580', 
