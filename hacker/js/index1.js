...
/* fake console stuff */
var commandStart = ['Performing DNS Lookups for ShirisKumar', 
                'Searching ', 
                'Analyzing ', 
                'Estimating Approximate Location of ', 
                'Compressing ', 
                'Requesting Authorization From 192.168.102.3', 
                'wget -a -t ', 
                'tar -xzf ', 
                'Entering Location ', 
    ...
    commandParts = ['Data Structure', 
                    'http://localhost/honeydev/honeydev.sql', 
                    'start sniff', 
                    'TPS Reports', 
                    ' .... Searching ... ', 
                    'http://localhost/phpmyadmin/?23&88&far=2', 
